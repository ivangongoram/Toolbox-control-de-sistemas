...
% x=0.5;%x=(0->1)
% ts=x*(ts2-ts1)+ts1
ts=0.27 %comentar cuando se dermine matematicamente el tiempo
...
d=0.5;%(0->1)distancia de los polos no dominante
